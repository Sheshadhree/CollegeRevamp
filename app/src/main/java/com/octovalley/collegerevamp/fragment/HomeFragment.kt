package com.octovalley.collegerevamp.fragment
...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    private val queryref = FirebaseStorage.getInstance().reference.child(Staffvalent.currentOnlineStaff?.collegeCode.toString())
    ...
    private fun saveProductToDatabase() {
        ...
        var S  = Staffvalent.currentOnlineStaff?.collegeCode.toString() + "1234"
        ...
        val sample = Sample (Staffvalent.currentOnlineStaff?.phoneNumber.toString(),sampleId,downloadImageUrl,currentDate,title,description,status)
